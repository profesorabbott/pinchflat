...
#
# Usage:
#   tooling/docker-build-local.sh                # build only, tag pinchflat:local
...
# (pinchflat-local): --run then follows its logs (Ctrl-C to exit), --shell waits
...
PORT="${PORT:-8945}"
CONTAINER_NAME="pinchflat-local"
